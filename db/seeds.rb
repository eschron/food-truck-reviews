...
user = User.create(email: 'cbrennan31@gmail.com', password: 'pwasdfasdfasf', first_name: "Casey", last_name: "Brennan")

fenway_truck = Truck.create(location: fenway, description: 'truck in fenway', user: user, name: "Great Food Truck")
